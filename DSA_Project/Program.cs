...
namespace DSA_Project
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nNext Learning is DSA, Separate positive and negative number in array");

            Array_array_positive_negative_number array_Array_Positive_Negative_Number = new Array_array_positive_negative_number();
            
            array_Array_Positive_Negative_Number.SeparatePositiveNegative();
